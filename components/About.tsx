...
const About = () => {
  return (
    <section id="about" className="text-primary-300 pt-10 lg:pt-20 text-base lg:text-lg">
      <h3 className="mb-4 font-bold text-primary-200 text-xl md:hidden">About</h3>
      <p>
      ...
      <p className="mt-4">
        With experience working on a variety of projects, I’ve had the chance to
        build everything from <span className="highlight">simple websites</span>{" "}
        to more <span className="highlight">complex web applications</span>. I
        focus on{" "}
        <span className="highlight">writing clean, efficient code</span> and
        ensuring that the final product delivers the best experience for users.
        Whether it’s{" "}
        <span className="highlight">designing a responsive layout</span> or
        making sure a website runs without problems, I’m committed to getting it
        right.
      </p>
      <p className="mt-4">
